...
<html lang="en">
	...
	<body class="footer-dark">
			...
			<div class="container">
				...
				<nav>
					...
					<ul class="nav-secondary">
						<li>
							<a href="contact.html"><i class="fas fa-phone icon-left"></i>+62 812 1494 007</a>
						</li>
						<li>
		...
		<section id="content">
			...
			<section id="pricing" class="content-row content-row-color content-row-clouds content-row-full-height">
				<div class="container">
					<header class="content-header content-header-large content-header-uppercase">
						<h1>
							Selamat Datang di <mark>SIMAPP</mark>
						</h1>
						<p>
							Spesialisasi dalam mengembangkan Sistem Informasi di Instansi manapun
						</p>
					</header>
            ...
            <!-- Daftar Aplikasi -->
            <section id="features" class="content-row content-row content-row-border-bottom" style="background-color: #ecf0f1">
				<div class="container">
                    <center>
                        <img src="https://pngimage.net/wp-content/uploads/2018/06/our-products-png-7.png" alt="Produk Kami">
                    </center>
                    <br>
					...
					<div class="column-row">
						<div class="column-33">
							<div class="feature-box">
								<div class="feature-header">
									<a href="home-single-page.html">
										<img src="uploads/demo-4.png" alt="">
									</a>
								</div>
							</div>
							<p class="text-color-gray text-align-center">
								Single Page
							</p>
						</div>
						<div class="column-33">
							<div class="feature-box">
								<div class="feature-header">
									<a href="home-product-slider.html">
										<img src="uploads/demo-5.png" alt="">
									</a>
								</div>
							</div>
							<p class="text-color-gray text-align-center">
						...
						<div class="column-33">
							<div class="feature-box">
								<div class="feature-header">
									<a href="home-light-slider.html">
										<img src="uploads/demo-6.png" alt="">
									</a>
								</div>
							</div>
							<p class="text-color-gray text-align-center">
					...
					<div class="column-row">
						<div class="column-33">
							<div class="feature-box">
								<div class="feature-header">
									<a href="home-user-onboarding.html">
										<img src="uploads/demo-7.png" alt="">
									</a>
								</div>
							</div>
							<p class="text-color-gray text-align-center">
						...
						<div class="column-33">
							<div class="feature-box">
								<div class="feature-header">
									<a href="home-domain-search.html">
										<img src="uploads/demo-8.png" alt="">
									</a>
								</div>
							</div>
							<p class="text-color-gray text-align-center">
						...
						<div class="column-33">
							<div class="feature-box">
								<div class="feature-header">
									<a href="home-custom-color.html">
										<img src="uploads/demo-9.png" alt="">
									</a>
								</div>
							</div>
							<p class="text-color-gray text-align-center">
            ...
            <!-- /Daftar Aplikasi -->
			<section id="featuresss" class="content-row">
				<div class="container">
				...
				<div class="container">
							...
							<div class="content-box">
								<div class="column-row">
									<div class="column-33">
										...
										<p>
											Tier 4 SAS 70 Type II Audited Facilities<br>
											Internap, Level 3, Cogent
										</p>
										<p>
											<a href="#speedtest-ch-nyc-1">Speedtest CH-NYC-1</a><br>
											<a href="#speedtest-ch-nyc-2">Speedtest CH-NYC-2</a>
										</p>
									</div>
									<div class="column-33">
										<h3>
										...
										<p>
											Tier 4 SSAE 16 Audited Facilities<br>
											Level 3, DeCIX, Deutsche Telekom
										</p>
										<p>
											<a href="#speedtest-ch-fra-1">Speedtest CH-FRA-1</a><br>
											<a href="#speedtest-ch-fra-2">Speedtest CH-FRA-2</a><br>
											<a href="#speedtest-ch-fra-3">Speedtest CH-FRA-3</a>
										</p>
									</div>
									<div class="column-33">
										<h3>
										...
										<p>
											Tier 4 SAS 70 Type II Audited Facilities<br>
											PCCW, HKIX, Starhub, Equinix Exchange Peers
										</p>
										<p>
											<a href="#speedtest-ch-tky-1">Speedtest CH-TKY-1</a><br>
											<a href="#speedtest-ch-tky-2">Speedtest CH-TKY-2</a>
										</p>
									</div>
								</div>
							</div>
							...
							<div class="content-box">
								<div class="column-row">
									<div class="column-33">
										...
										<p>
											<a href="#speedtest-ch-ldn-1">Speedtest CH-LDN-1</a>
										</p>
									</div>
									<div class="column-33">
										<h3>
										...
										<p>
											<a href="#speedtest-ch-sfa-1">Speedtest CH-SFA-1</a><br>
											<a href="#speedtest-ch-sfa-2">Speedtest CH-SFA-2</a>
										</p>
									</div>
									<div class="column-33">
										<h3>
										...
										<p>
											<a href="#speedtest-ch-spa-1">Speedtest CH-SPA-1</a>
										</p>
									</div>
								</div>
								<div class="column-row">
									<div class="column-33">
										...
										<p>
											<a href="#speedtest-ch-dal-1">Speedtest CH-DAL-1</a>
										</p>
									</div>
									<div class="column-33">
										<h3>
										...
										<p>
											<a href="#speedtest-ch-lis-1">Speedtest CH-LIS-1</a>
										</p>
									</div>
									<div class="column-33">
										<h3>
										...
										<p>
											<a href="#speedtest-ch-sdy-1">Speedtest CH-SDY-1</a>
										</p>
									</div>
								</div>
							</div>
					...
					<div class="column-row align-center">
						<div class="column-50 text-align-center">
							<p>
								<small class="text-color-gray">We fully own and operate the datacenters in our primary locations, the secondary locations however are rented floor space of our infrastructure provider partners.</small>
							</p>
						</div>
					</div>
				</div>
			...
			<!-- Content Row -->
			<section id="about" class="content-row">
				<div class="container">
					<header class="content-header">
						<h2>
							Management Team
						...
						<p>
							Our team of developers and engineers is passionate about providing our customers the best and most reliable cloud hosting infrastructure on the market.
						</p>
					</header>
					<div class="column-row text-align-center">
						<div class="column-33">
							<img width="256" src="uploads/team-1.png">
							<h3>
								William Crawford
							</h3>
							<p>
								<span class="text-color-gray">Director of Operations</span>
								<span class="group align-center">
									<a href="#email"><i class="fas fa-envelope"></i></a>
						...
						<div class="column-33">
							<img width="256" src="uploads/team-2.png">
							<h3>
								Thomas Hoffmann
							</h3>
							<p>
								<span class="text-color-gray">Lead Cloud Architect</span>
								<span class="group align-center">
									<a href="#email"><i class="fas fa-envelope"></i></a>
									<a href="#twitter"><i class="fab fa-twitter"></i></a>
									<a href="#linkedin"><i class="fab fa-linkedin"></i></a>
						...
						<div class="column-33">
							<img width="256" src="uploads/team-3.png">
							<h3>
								Michael Martinez
							</h3>
							<p>
								<span class="text-color-gray">Head of Product Design</span>
								<span class="group align-center">
									<a href="#email"><i class="fas fa-envelope"></i></a>
									<a href="#twitter"><i class="fab fa-twitter"></i></a>
									<a href="#linkedin"><i class="fab fa-linkedin"></i></a>
			...
			<!-- Content Row -->
			<section id="contact" class="content-row content-row-color">
				<div class="container">
					<header class="content-header">
						<h2>
							Send Us A Message
							...
							<div class="column-row align-right-top">
								...
								<div class="column-33">
									...
									<ul>
										...
										<li>
											<a href="#features">Cloud Features</a>
										</li>
										<li>
											<a href="#network">Global Network</a>
										</li>
										<li>
											<a href="#about">About Cloudhub</a>
										</li>
										<li>
